...
public class RegisterBean {
    ...
    public String register() {
        ...
        if (existingUser != null) {
            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Email is already registered.", ""));
            return null;
        }
        ...
        if ("Driver".equals(role)) {
            ...
            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Invalid role selected.", ""));
            return null;
        }
